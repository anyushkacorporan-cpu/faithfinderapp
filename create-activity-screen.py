...
activity_screen = '''import { View, Text, ScrollView, TouchableOpacity, StyleSheet } from 'react-native';
...
with open('app/activity.tsx', 'w', encoding='utf-8') as f:
    f.write(activity_screen)
print('Created app/activity.tsx')

# Register route in _layout.tsx
with open('app/_layout.tsx', 'r', encoding='utf-8') as f:
    layout = f.read()

if '"activity"' not in layout:
    ...
    if old in layout:
        ...
        with open('app/_layout.tsx', 'w') as f:
            f.write(layout)
        print('Activity route registered in _layout.tsx')
    else:
        print('ERROR: layout anchor not found')
else:
    print('Activity route already registered')
