...
settings_store = '''import { useState, useEffect } from 'react';
...
export type PrivacyPrefs = {
  publicProfile: boolean; showLocation: boolean; allowMessages: boolean;
};
...
const DEFAULT_SETTINGS: AppSettings = {
  ...
  privacy: {
    publicProfile: true, showLocation: false, allowMessages: true,
  },
  location: {
...
with open('src/lib/settingsStore.ts', 'w', encoding='utf-8') as f:
    f.write(settings_store)

print('Created src/lib/settingsStore.ts')
