...
confirm_component = '''import { createContext, useContext, useState } from 'react';
...
with open('src/components/Confirm.tsx', 'w', encoding='utf-8') as f:
    f.write(confirm_component)

print('Created src/components/Confirm.tsx')
